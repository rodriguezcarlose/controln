            ...
            if (isset($_SESSION['addrecords']) ) {
               // $detalle =$this->payments_model->getTablepaymentsTem($_SESSION['addrecords']);
                ...
                if ($resultado){
                    ...
                    $this->email->to($to);
                    $this->email->subject('Control Nomina - Liberada (' . "$subject".')' );
                    $this->email->message('Nomina <strong>' . "$subject". '</strong> cargada exitosamente.');
                    $this->email->send();
                    ...
                    $this->email->to($to);
                    $this->email->subject('Control Nomina - Liberada (' . "$subject".')' );
                    $this->email->message('Se notifica que la Gerencia <strong>'."$gerencianomina" . '</strong> cargo una nómina <strong>' . "$subject". '</strong> para ser procesada.');
                    $this->email->send();
