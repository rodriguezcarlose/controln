...
class User_model extends CI_Model {
    ...
    public function get_user_from_documento($document) {
        ...
        $this->db->select('u.id as id_usuario, u.correo, u.estatus,e.id as id_empleado, e.nombre, e.apellido, e.id_cargo, e.id_gerencia, e.documento_identidad, e.id_tipo_documento,u.id_rol');
