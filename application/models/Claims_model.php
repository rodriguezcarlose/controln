...
class Claims_model extends CI_Model
{
    ...
    public function details($idreclamo){
        ...
        b.nombre as banco ,r.numero_cuenta,tc.tipo,p.nombre as proyecto ,g.nombre as gerencia ,c.nombre as cargo,
        te.nombre_error,er.nombre_reclamo,r.fecha_reclamo,r.soportereclamos,r.cantidad_dias');
        $this->db->from('reclamo r');
